...
using PCEFI_GUID = const EFI_GUID*;
...
using CEFI_MEMORY_TYPE = const EFI_MEMORY_TYPE;
using PCEFI_MEMORY_TYPE = const EFI_MEMORY_TYPE*;
...
using CEFI_ALLOCATE_TYPE = const EFI_ALLOCATE_TYPE;
using PCEFI_ALLOCATE_TYPE = const EFI_ALLOCATE_TYPE*;
...
using CEFI_SYSTEM_TABLE = const EFI_SYSTEM_TABLE;
using PCEFI_SYSTEM_TABLE = const EFI_SYSTEM_TABLE*;
...
using CLIST_ENTRY = const LIST_ENTRY;
using PCLIST_ENTRY = const LIST_ENTRY*;

using EFI_FVB_ATTRIBUTES_2 = UINT32;
using CEFI_FVB_ATTRIBUTES_2 = const EFI_FVB_ATTRIBUTES_2;
using PEFI_FVB_ATTRIBUTES_2 = const UINT32*;
using PCEFI_FVB_ATTRIBUTES_2 = const UINT32*;
...
using CEFI_FV_BLOCK_MAP_ENTRY = const EFI_FV_BLOCK_MAP_ENTRY;
using PCEFI_FV_BLOCK_MAP_ENTRY = const EFI_FV_BLOCK_MAP_ENTRY*;
...
using CEFI_FIRMWARE_VOLUME_HEADER = const EFI_FIRMWARE_VOLUME_HEADER;
using PCEFI_FIRMWARE_VOLUME_HEADER = const EFI_FIRMWARE_VOLUME_HEADER*;
